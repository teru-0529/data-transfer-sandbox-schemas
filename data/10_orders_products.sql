...
COMMENT ON COLUMN orders.products.product_pic IS '商品管理者ID';
COMMENT ON COLUMN orders.products.product_status IS '商品ステータス';
...
ALTER TABLE orders.products ADD CONSTRAINT products_unique_1 UNIQUE (
  product_name
);
